...
def parse(opt_path, is_train=True):
    ...
    # Device selection is controlled by the process environment (for example,
    # CUDA_VISIBLE_DEVICES).  Keep YAML portable across machines by not
    # embedding physical GPU indices in an option file.
